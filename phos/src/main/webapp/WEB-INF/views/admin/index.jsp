...
<meta charset="UTF-8">
    ...
    <link rel="apple-touch-icon" href="https://github.com/hyejinyoon20010716/phos/assets/119990564/570155ba-4b80-4712-905f-e87a99da5aa4">
...
<body>
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand hidden" href="./"><img src="${cpath}/resources/images/logo.png" alt="Logo"></a>
                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            ...
                                            <div class="stat-heading">일 매출</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            ...
                                            <div class="stat-heading">일 방문자 수</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            ...
                                            <div class="stat-heading">총 방문자 수</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
			        ...
			        <nav class="navbar navbar-expand-sm navbar-default">
			            <div id="main-menu" class="main-menu collapse navbar-collapse">
			                <ul class="nav navbar-nav">
			                    ...
			                    <li class="menu-title">Extras</li><!-- /.menu-title -->
			                    <li>
			                    	 <a href="${cpath}/admin/board"><i class="menu-icon fa fa-laptop"></i>게시판 관리 </a>
			                    </li>
			                    <li class="menu-item-has-children dropdown">
			                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-glass"></i>페이지</a>
			                        <ul class="sub-menu children dropdown-menu">
    ...
    <script src="${cpath}/resources/js/main.js"></script>
    <!--  Chart js -->
    <script src="${cpath}/resources/js/chartjs-init.js"></script>
    <!--Flot Chart-->
</body>
</html>
